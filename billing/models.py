...
class BillingProfile(models.Model):
    ...
    def default_card(self):
        default_cards_qs = self.get_cards().filter(active=True, default=True)
        if default_cards_qs.exists():
            return default_cards_qs.first()
        else:
            return None
...
class Card(models.Model):   
    ...
    def __str__(self):
        return "Brand: {} Last4 Digits: {}".format(self.brand, self.last4)
