...
class ObjectViewed(models.Model):
    ...
    # Content Type grabs seperate models instead of instantiating indvidual model variables
    ...
    class Meta:
        ordering = ['-timestamp']  # the most recent saved show up first
...
def user_logged_in_reveiver(sender, instance, request, *args, **kwargs):
    print(instance)
    user = instance 
    ip_address = get_client_ip(request)
...
user_logged_in.connect(user_logged_in_reveiver)
